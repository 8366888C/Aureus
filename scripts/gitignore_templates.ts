...
*.ali
`,
"AdventureGameStudio": `# Built things
_Debug/
Compiled/
...
# composer.lock
`,
"Concrete5": `# ignore the error log and .htaccess and others
error_log
.htaccess
...
`,
"CraftCMS": `# Craft 2 Storage (https://craftcms.com/support/craft-storage-gitignore)
...
modules/
`,
"Dotnet": `## A streamlined .gitignore for modern .NET projects
...
TestResult.xml
nunit-*.xml`,
"Drupal": `# gitignore template for Drupal 8 projects
#
...
*copy.mus
`,
"Firebase": `# Firebase build and deployment files
/firebase-debug.log
/firebase-debug.*.log
.firebaserc
...
/.env.*
`,
"FlaxEngine": `# Ignore Flax project files
Binaries/
Cache/
Logs/
Output/
...
*.pdf
`,
"GitHubPages": `# This .gitignore is appropriate for repositories deployed to GitHub Pages and using
...
*.DEPLOYED
`,
"JENKINS_HOME": `# Learn more about Jenkins and JENKINS_HOME directory for which this file is
# intended.
#
#  http://jenkins-ci.org/
...
/web.config.txt
`,
"Julia": `# Files generated by invoking Julia with --code-coverage
*.jl.cov
*.jl.*.cov
...
hs_err_pid*
`,
"KiCad": `# For PCBs designed using KiCad: https://www.kicad.org/
...
.cache/
`,
"LangChain": `# gitignore template for LangChain products, e.g., LangGraph, LangSmith
...
junit*.properties
`,
"Modelica": `# Modelica - an object-oriented language for modeling of cyber-physical systems
# https://modelica.org/
...
.tmp
`,
"Nextjs": `# See https://help.github.com/articles/ignoring-files/ for more about ignoring files.
...
htmldocs/
`,
"Nix": `# Ignore build outputs from performing a nix-build or \`nix build\` command
result
result-*
...
var/
`,
"Prestashop": `# Cache, temp and personal files
...
/public/uploads
`,
"Raku": `# Gitignore for Raku (https://raku.org)
...
.sconf_temp
`,
"SSDT-sqlproj": `## Ignore Visual Studio SSDT sqlproj specific temporary files, build results, etc
## 
##
...
github-*.zip
`,
"Solidity-Remix": `# Remix compiler artifacts
**/artifacts/
**/artifacts/**
...
terraform.rc
`,
"TestComplete": `# Test Complete ignore files: https://support.smartbear.com/viewarticle/68002/
...
.lock-waf_*_build
`,
"WordPress": `# Wordpress - ignore core, configuration, examples, uploads and logs.
...
*.o
`,
"ecu.test": `# gitignore template for ecu.test workspaces - by tracetronic https://tracetronic.com
